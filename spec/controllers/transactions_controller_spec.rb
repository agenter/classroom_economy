  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved transaction as @transaction" do
        ...
        post :create, {:transaction => { "from_account" => "invalid value" }}, valid_session
        assigns(:transaction).should be_a_new(Transaction)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested transaction" do
        ...
        Transaction.any_instance.should_receive(:update_attributes).with({ "from_account" => "" })
        put :update, {:id => transaction.to_param, :transaction => { "from_account" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the transaction as @transaction" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Transaction.any_instance.stub(:save).and_return(false)
        put :update, {:id => transaction.to_param, :transaction => { "from_account" => "invalid value" }}, valid_session
        assigns(:transaction).should eq(transaction)
      end
