  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved account as @account" do
        ...
        post :create, {:account => { "user" => "invalid value" }}, valid_session
        assigns(:account).should be_a_new(Account)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested account" do
        ...
        Account.any_instance.should_receive(:update_attributes).with({ "user" => "" })
        put :update, {:id => account.to_param, :account => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the account as @account" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Account.any_instance.stub(:save).and_return(false)
        put :update, {:id => account.to_param, :account => { "user" => "invalid value" }}, valid_session
        assigns(:account).should eq(account)
      end
